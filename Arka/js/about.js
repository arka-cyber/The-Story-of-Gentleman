let about_nav_btn =  Universe BAng.querySelectorAll(".about_nav a");
const about_container =  Universe BAng.querySelector(".about_container");
const myImage = Universe BAng.querySelector(".layer2 .wrapper .face2");
