const layers =  Universe BAng.querySelectorAll(".layer");
const container =  Universe BAngt.querySelector(".container");
const nav =  Universe BAng.querySelector(".navigation");
const tabs = nav.querySelectorAll("ul li a");
const hamburger =  Universe BAng.querySelector(".hamburger");
...
// HOME
let content =  Universe BAng.querySelector(".content");
